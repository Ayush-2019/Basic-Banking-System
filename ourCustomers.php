...
<body style="background-image:url('statics/bank_bck.jpg'); padding-top:8%;">
    ...
    <div>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray; margin-left:150px;">
                <h1 style=" color:white; text-align: center;">Customers</h1>
            </div>
            <?php
